...
namespace RetrieverCore.Models.WindowsModels.Decoders
{
    ...
    {
        public static string Decode(UInt16 family)
        {
            switch (family)
            {
                case 1:
                ...
                case 43:
                    return "Intel(R) Atom(TM) processor";
                case 48:
                    return "Alpha Family";
                case 49:
                    return "Alpha 21064";
                ...
                case 55:
                    return "Alpha 21364";
                case 56:
                    return "AMD Turion(TM) II Ultra Dual-Core Mobile M Processor Family";
                case 57:
                    return "AMD Turion(TM) II Dual-Core Mobile M Processor Family";
                case 58:
                    return "AMD Athlon(TM) II Dual-Core Mobile M Processor Family";
                case 59:
                    return "AMD Opteron(TM) 6100 Series Processor";
                case 60:
                    return "AMD Opteron(TM) 4100 Series Processor";
                case 64:
                    return "MIPS Family";
                case 65:
                    return "MIPS R4000";
                ...
                case 182:
                    return "AMD Athlon(TM) XP Family";
                case 183:
                    return "AMD Athlon(TM) MP Family";
                case 184:
                ...
                case 200:
                    return "S/390 and zSeries Family";
                case 201:
                    return "ESA/390 G4";
                case 202:
                    return "ESA/390 G5";
                ...
                case 206:
                    return "Intel(R) Core(TM) i3 processor";
                case 210:
                ...
                case 217:
                    return "VIA Nano(TM) Processor Family";
                case 218:
                ...
                case 224:
                    return "Multi-Core Intel(R) Xeon(R) processor 3400 Series";
                case 230:
                ...
                case 236:
                    return "AMD Phenom(TM) II Processor Family";
                case 237:
                    return "AMD Athlon(TM) II Processor Family";
                case 238:
                    return "Six-Core AMD Opteron(TM) Processor Family";
                case 239:
                    return "AMD Sempron(TM) M Processor Family";
                case 250:
                    return "i860";
                case 251:
                    return "i960";
                case 254:
                    return "Reserved (SMBIOS Extension)";
                case 255:
                    return "Reserved (Un-initialized Flash Content - Lo)";
                case 260:
                    return "SH-3";
                case 261:
                    return "SH-4";
                ...
                case 65534:
                    return "Reserved (For Future Special Purpose Assignment)";
                case 65535:
                    return "Reserved (Un-initialized Flash Content - Hi)";
                default:
                    return "Unknown";
            }
        }
