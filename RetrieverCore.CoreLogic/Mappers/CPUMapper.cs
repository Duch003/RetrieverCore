...
namespace RetrieverCore.CoreLogic.Mappers
{
    public static class CPUMapper
    {
        ...
        {
            var output = new CPU();
            output.Architecture = ArchitectureDecoder.Decode(win32Processor.Architecture ?? 0);
            ...
            output.ModelWithVendor = win32Processor.Name;
            ...
            output.Caption = win32Processor.Caption;
